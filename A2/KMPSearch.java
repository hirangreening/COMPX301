...
public class KMPSearch {
     ...
     * The skip table is a map where each character in the target string
     * is associated with an array of integers representing the skip values.
     ...
     * table.
     * It reads the file line by line and prints the 1-based index of the first
     * occurrence of the target string in each line.
    ...
    private static List<Integer> kmpSearchWithSkipTable(String text, String pattern, Map<Character, int[]> skipTable) {
        ...
        while (i <= n - m) {
            ...
            if (j == m) {
                ...
                // check if the mismatched character is in the skip table
                ...
                // if end of text is reached, break the loop
                break;
            }
        }
